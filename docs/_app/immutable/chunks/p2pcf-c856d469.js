...
const getBrowserRTC$1 = getBrowserRtc;
var events = { exports: {} };
...
const hexToBase64 = (hex) => encode(convertHex.exports.hexToBytes(hex));
const base64ToHex = (b64) => arrayBufferToHex(decode(b64));
...
class P2PCF extends events.exports {
  constructor(clientId = "", roomId = "", options = {}) {
    ...
    if (!((_a = window.history.state) == null ? void 0 : _a._p2pcfContextId)) {
    ...
    for (const remotePeerData of remotePeerDatas) {
      ...
      if (isPeerA) {
        ...
        const initialCandidateSignalling = (e) => {
          var _a;
          if (!((_a = e.candidate) == null ? void 0 : _a.candidate))
            return;
...
//# sourceMappingURL=p2pcf-c856d469.js.map
