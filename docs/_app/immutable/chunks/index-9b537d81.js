...
import { S as SvelteComponent, i as init, s as safe_not_equal, k as element, l as claim_element, m as children, h as detach, n as attr, b as insert_hydration, f as transition_in, g as group_outros, t as transition_out, d as check_outros, I as createEventDispatcher, o as onMount, v as construct_svelte_component, w as create_component, a as space, e as empty, x as claim_component, c as claim_space, y as mount_component, z as destroy_component, C as create_slot, D as update_slot_base, E as get_all_dirty_from_scope, F as get_slot_changes, _ as svg_element, $ as claim_svg_element, a1 as xlink_attr, G as append_hydration, B as noop, U as toggle_class, J as listen, a0 as action_destroyer, T as run_all, L as add_render_callback, M as create_bidirectional_transition, a2 as null_to_empty, p as set_style, a3 as src_url_equal, Q as set_input_value, a4 as add_resize_listener, a5 as globals, q as text, r as claim_text, u as set_data, O as binding_callbacks, P as bind, Y as is_function, R as add_flush_callback, a6 as bubble } from "./index-4317dbfd.js";
import { a as fade } from "./DropDown-ac750261.js";
...
const a = (e2, t2 = {}) => {
  ...
  let S, H, L = false, D = 0, N = 0, R = 0, T = 0, B = 0, q = 0, { x: $, y: z } = f2 ? { x: (f2 == null ? void 0 : f2.x) ?? 0, y: (f2 == null ? void 0 : f2.y) ?? 0 } : E;
  m($, z, e2, r2);
  let X, Y, j, k, O = "", P = !!f2;
  ...
  return { destroy: () => {
    ...
    var _a, _b;
    o2 = t3.axis || "both", a2 = t3.disabled ?? false, d2 = t3.ignoreMultitouch ?? false, y = t3.handle, n2 = t3.bounds, g2 = t3.cancel, i2 = t3.applyUserSelectHack ?? true, h2 = t3.grid, r2 = t3.gpuAcceleration ?? true;
    const s2 = W.contains(v);
    W.remove(b, v), b = t3.defaultClass ?? "neodrag", w = t3.defaultClassDragging ?? "neodrag-dragging", v = t3.defaultClassDragged ?? "neodrag-dragged", W.add(b), s2 && W.add(v), P && ($ = D = ((_a = t3.position) == null ? void 0 : _a.x) ?? D, z = N = ((_b = t3.position) == null ? void 0 : _b.y) ?? N, M.then(() => m(D, N, e2, r2)));
  } };
}, s = (e2) => {
  var _a;
  return !!((_a = e2.touches) == null ? void 0 : _a.length);
...
}, f = (h == null ? void 0 : h.cache) ?? i, g = (h == null ? void 0 : h.serializer) ?? o, ((h == null ? void 0 : h.strategy) ?? n)(d, { cache: f, serializer: g }));
var d, h, f, g;
function p(e2, t2) {
...
const get_default_slot_changes = (dirty) => ({
  saveInputURL: dirty & /*saveInputURL*/
  8,
  url: dirty & /*inputUrl*/
  1
});
...
function create_if_block$2(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      if (default_slot) {
        if (default_slot.p && (!current || dirty & /*$$scope, saveInputURL, inputUrl*/
        265)) {
          update_slot_base(
            default_slot,
            default_slot_template,
...
function instance$3($$self, $$props, $$invalidate) {
  ...
  onMount(async () => {
    ...
    const { ImmortalDB } = await __vitePreload(() => import("./index-57f72d91.js"), true ? [] : void 0, import.meta.url);
...
function create_if_block_3(ctx) {
  ...
  return {
    ...
    h() {
      ...
      attr(svg, "class", "svg svelte-cpdbc1");
      attr(svg, "xmlns", "http://www.w3.org/2000/svg");
...
function create_fragment$2(ctx) {
  ...
  let if_block0 = (
    /*icon*/
    ctx[0] === "close" && create_if_block_3()
  );
  let if_block1 = (
    /*icon*/
    ctx[0] === "launch" && create_if_block_2()
  );
  let if_block2 = (
    /*icon*/
    ctx[0] === "plug" && create_if_block_1()
  );
  let if_block3 = (
    /*icon*/
    ctx[0] === "unplug" && create_if_block$1()
  );
  const default_slot_template = (
    /*#slots*/
    ctx[3].default
  ...
  return {
    ...
    h() {
      attr(div, "class", "img-container svelte-cpdbc1");
      attr(button, "class", "cursor-pointer flex flex-auto relative opacity-80 h-full items-center justify-center text-inherit bg-none border-none m-0 p-0 text-base bg-inherit svelte-cpdbc1");
    },
    m(target, anchor) {
...
function create_default_slot$1(ctx) {
  ...
  return {
    ...
    h() {
      var _a;
      attr(span, "class", span_class_value = /*wallet*/
      (((_a = ctx[0]) == null ? void 0 : _a.address) ? " connected " : " disconnected ") + " hidden sm:flex svelte-14h24u4");
    },
    m(target, anchor) {
    ...
    p(ctx2, dirty) {
      var _a;
      if (dirty & /*data, src*/
      640 && t_value !== (t_value = /*data*/
      ctx2[9].loading || !/*src*/
      ctx2[7] ? "Loading..." : "Load"))
        set_data(t2, t_value);
      if (dirty & /*wallet*/
      1 && span_class_value !== (span_class_value = /*wallet*/
      (((_a = ctx2[0]) == null ? void 0 : _a.address) ? " connected " : " disconnected ") + " hidden sm:flex svelte-14h24u4")) {
...
function create_fragment$1(ctx) {
  ...
  return {
    ...
    h() {
      var _a, _b;
      attr(div0, "class", "actions logo svelte-14h24u4");
      attr(a2, "class", "flex-0 hidden md:flex svelte-14h24u4");
      attr(a2, "href", "https://PeerPiper.io");
      attr(a2, "target", "_blank");
      attr(a2, "rel", "noreferrer");
      attr(input, "class", "border-b-4 border-toxic url pl-0 p-2 pr-0 m-2 text-white bg-none border-none text-sm sm:text-base outline-none svelte-14h24u4");
      attr(input, "placeholder", placeholder);
      attr(span, "class", "border-b-4 border-toxic flex-1 relative -top-2 svelte-14h24u4");
      attr(div1, "class", "flex-shrink flex flex-col w-full pl-2 md:p-2 svelte-14h24u4");
      attr(div2, "class", div2_class_value = null_to_empty(
        /*data*/
        ((_a = ctx[9]) == null ? void 0 : _a.loading) ? "action dim" : (
          /*wallet*/
          ((_b = ctx[0]) == null ? void 0 : _b.address) ? " connected " : " disconnected "
        )
      ) + " svelte-14h24u4");
      attr(div3, "class", "hidden md:flex svelte-14h24u4");
      attr(div4, "class", "flex flex-row space-between items-center svelte-14h24u4");
      set_style(
        div4,
        "--topOffsetHeight",
        /*topOffsetHeight*/
      ...
      attr(iframe_1, "class", "w-full border-none min-h-full svelte-14h24u4");
      ...
      attr(div5, "class", "iframe flex svelte-14h24u4");
      set_style(div5, "height", "calc(" + /*iframeParentHeight*/
      ctx[4] + "px + 18px)");
      add_render_callback(() => (
        /*div5_elementresize_handler*/
        ctx[24].call(div5)
      ));
      attr(div6, "class", "flex flex-col m-2 max-w-full h-screen svelte-14h24u4");
    },
    m(target, anchor) {
      ...
      div4_resize_listener = add_resize_listener(
        div4,
        /*div4_elementresize_handler*/
        ctx[22].bind(div4)
      );
      ...
      ctx[23](iframe_1);
      div5_resize_listener = add_resize_listener(
        div5,
        /*div5_elementresize_handler*/
        ctx[24].bind(div5)
      );
    ...
    p(ctx2, [dirty]) {
      ...
      if (dirty & /*connectionIcon*/
      1024)
        iconbutton_changes.icon = /*connectionIcon*/
        ctx2[10];
      if (dirty & /*$$scope, wallet, data, src*/
      536871553) {
        iconbutton_changes.$$scope = { dirty, ctx: ctx2 };
      }
      iconbutton.$set(iconbutton_changes);
      if (!current || dirty & /*data, wallet*/
      513 && div2_class_value !== (div2_class_value = null_to_empty(
        /*data*/
        ((_a = ctx2[9]) == null ? void 0 : _a.loading) ? "action dim" : (
          /*wallet*/
          ((_b = ctx2[0]) == null ? void 0 : _b.address) ? " connected " : " disconnected "
        )
      ) + " svelte-14h24u4")) {
        attr(div2, "class", div2_class_value);
      }
      if (!current || dirty & /*topOffsetHeight*/
      4) {
        set_style(
          div4,
          "--topOffsetHeight",
      ...
      128 && !src_url_equal(iframe_1.src, iframe_1_src_value = /*src*/
      ctx2[7])) {
        attr(iframe_1, "src", iframe_1_src_value);
      }
      if (!current || dirty & /*iframeParentHeight*/
      16) {
        set_style(div5, "height", "calc(" + /*iframeParentHeight*/
        ctx2[4] + "px + 18px)");
      }
...
function instance$1($$self, $$props, $$invalidate) {
  ...
  $$self.$$.update = () => {
    ...
    if ($$self.$$.dirty & /*iframeOffsetWidth, wallet*/
    33) {
...
function create_if_block(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      if (dirty & /*inputUrl*/
      2)
        menuwrapper_changes.inputUrl = /*inputUrl*/
        ctx2[1];
      if (dirty & /*$$scope, openNav, hideNav, url, wallet, saveInputURL*/
      993) {
...
function create_default_slot(ctx) {
  ...
  if (
    ...
    connectorinside_props.wallet = /*wallet*/
    ctx[0];
  }
  ...
  return {
    ...
    p(new_ctx, dirty) {
      ...
      if (dirty & /*openNav*/
      32)
        connectorinside_changes.show = /*openNav*/
        ctx[5];
      if (dirty & /*hideNav*/
      64)
        connectorinside_changes.hide = /*hideNav*/
        ctx[6];
      if (dirty & /*url*/
      256)
        connectorinside_changes.inputUrl = /*url*/
        ctx[8];
      if (!updating_wallet && dirty & /*wallet*/
      1) {
        updating_wallet = true;
        connectorinside_changes.wallet = /*wallet*/
        ctx[0];
...
//# sourceMappingURL=index-9b537d81.js.map
